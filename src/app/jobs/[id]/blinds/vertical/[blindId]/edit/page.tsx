...
export default function EditVerticalBlind() {
  ...
  const handleSubmit = async (values: VerticalBlind) => {
    ...
    try {
      ...
      router.push(`/jobs/${jobId}/blinds/vertical/${blindId}`);
    } catch (error) {
  ...
  return (
    <main className="container mx-auto px-4 py-6 max-w-md">
      <header className="flex items-center mb-6">
        ...
        <h1 className="text-xl font-bold text-white">Edit Vertical Blind</h1>
      </header>
