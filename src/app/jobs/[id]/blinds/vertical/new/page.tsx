...
export default function NewVerticalBlind() {
  ...
  const handleSubmit = async (values: BlindFormState) => {
    ...
    try {
      ...
      console.log('Creating new vertical blind:', values);
      ...
      console.error('Error creating vertical blind:', error);
  ...
  return (
    <main className="container mx-auto px-4 py-6 max-w-md">
      <header className="flex items-center mb-6">
        <Link href={`/jobs/${jobId}/blinds`} className="text-white hover:text-primary-300 mr-4">
          <FaArrowLeft className="text-xl" />
        </Link>
        <h1 className="text-xl font-bold text-white">Add Vertical Blind</h1>
      </header>
            ...
            <Form className="space-y-4">
              ...
              <div>
                ...
                <Field 
                  ...
                  rows={3} 
                  className="input-field" 
                  placeholder="Slat color, draw direction, controls, etc."
                />
              </div>
              ...
              <div className="pt-4">
                ...
                >
                  {isSubmitting ? 'Saving...' : 'Save Vertical Blind'}
                </button>
              </div>
            </Form>
          )}
