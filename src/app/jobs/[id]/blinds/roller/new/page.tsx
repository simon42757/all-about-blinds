...
export default function NewRollerBlind() {
  ...
  const handleSubmit = async (values: BlindFormState) => {
    ...
    try {
      ...
      console.log('Creating new roller blind:', values);
      ...
      console.error('Error creating roller blind:', error);
  ...
  return (
    <main className="container mx-auto px-4 py-6 max-w-md">
      <header className="flex items-center mb-6">
        ...
        <h1 className="text-xl font-bold text-white">Add Roller Blind</h1>
      </header>
            ...
            <Form className="space-y-4">
              ...
              <div>
                ...
                <Field 
                  ...
                  rows={3} 
                  className="input-field" 
                  placeholder="Fabric type, color, control side, etc."
                />
              </div>
              ...
              <div className="pt-4">
                ...
                >
                  {isSubmitting ? 'Saving...' : 'Save Roller Blind'}
                </button>
              </div>
            </Form>
          )}
