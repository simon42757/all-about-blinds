...
export function generateStaticParams() {
  ...
  return [
    { id: 'JOB001', blindId: 'VN001' },
    { id: 'JOB002', blindId: 'VN002' },
    { id: 'JOB003', blindId: 'VN003' },
  ];
}
  ...
  return new Promise((resolve) => {
    setTimeout(() => {
      resolve({
        ...
        quantity: 3,
        cost: 185.75,
        aoi: 'White aluminum, 25mm slats. Premium tilt wand mechanism with cord lift. Child safety features included.'
      });
    }, 300);
  });
};

export default function VenetianBlindDetails() {
  ...
  return (
    <main className="container mx-auto px-4 py-6 max-w-md">
      <header className="flex items-center mb-6">
        ...
        <h1 className="text-xl font-bold text-white">Venetian Blind Details</h1>
      </header>
      ...
      <div className="card">
        <div className="flex justify-between items-start mb-6">
          ...
          <div className="flex space-x-2">
            <Link 
              href={`/jobs/${jobId}/blinds/venetian/${blindId}/edit`} 
