...
export default function DuplicateVenetianBlind() {
    ...
    const loadBlindData = async () => {
      try {
        ...
        const duplicatedBlind = {
          ...
          id: `VN${Math.floor(1000 + Math.random() * 9000)}` // Generate a random ID
        };
  ...
  return (
    <main className="container mx-auto px-4 py-6 max-w-md">
      <header className="flex items-center mb-6">
        ...
        <h1 className="text-xl font-bold text-white">Duplicate Venetian Blind</h1>
      </header>
